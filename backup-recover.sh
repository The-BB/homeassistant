...
$PATCH_DIR/lang-python-MarkupSafe-bump-to-2.1.3.patch
...
$PATCH_DIR/lang-python-python-certifi-bump-to-2023.7.22.patch
...
$PATCH_DIR/lang-python-python-multidict-bump-to-6.0.4.patch
...
$PATCH_DIR/lang-python-python-typing-extensions-bump-to-4.7.1.patch
