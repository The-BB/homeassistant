...
$PATCH_DIR/lang-python-pillow-bump-to-10.0.1.patch
$PATCH_DIR/lang-python-python-aiohttp-bump-to-3.8.6.patch
...
$PATCH_DIR/lang-python-python-sqlalchemy-bump-to-2.0.21.patch
