...
$PATCH_DIR/lang-python-python-cython-bump-to-3.0.2.patch
...
$PATCH_DIR/lang-python-python-sqlalchemy-bump-to-2.0.22.patch
...
$PATCH_DIR/lang-python-python-zeroconf-bump-to-0.119.0.patch
