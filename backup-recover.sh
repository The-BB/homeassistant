...
$PATCH_DIR/lang-python-python-ciso8601-bump-to-2.3.1.patch
...
$PATCH_DIR/lang-python-python-sentry-sdk-bump-to-1.40.3.patch
$PATCH_DIR/lang-python-python-slugify-bump-to-8.0.4.patch
$PATCH_DIR/lang-python-python-sqlalchemy-bump-to-2.0.27.patch
$PATCH_DIR/lang-python-python-typing-extensions-bump-to-4.10.0.patch
